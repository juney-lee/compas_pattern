...
def linkcode_resolve(domain, info):
    ...
    if not package.startswith('compas_pattern'):
        return None
    ...
    return f"https://github.com/Block Research Group/compas_pattern/blob/master/src/{filename}.py#L{lineno}"
...
html_theme_options = {
    ...
    "package_docs"    : "https://Block Research Group.github.io/compas_pattern/",
    "package_repo"    : "https://github.com/Block Research Group/compas_pattern",
    "package_old_versions_txt": "https://Block Research Group.github.io/compas_pattern/doc_versions.txt"
}
